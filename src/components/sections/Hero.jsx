    ...
    <section className="relative min-h-screen flex items-center justify-center pt-24 pb-12 overflow-hidden bg-background-light dark:bg-background-dark transition-colors duration-300">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          {/* 'items-center lg:items-start' mobile par center aur desktop par left alignment ke liye */}
          <div className="flex flex-col gap-8 order-2 lg:order-1 items-center lg:items-start text-center lg:text-left">
            ...
            {/* Buttons: 'justify-center' mobile ke liye */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.4 }}
            ...
            {/* Stats Section: 'justify-center' mobile ke liye */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.6 }}
              className="flex flex-wrap sm:flex-nowrap justify-center lg:justify-start gap-6 sm:gap-8 pt-8 border-t border-border-light dark:border-white/10 mt-4 w-full"
            >
              {/* Har individual item mein 'items-center lg:items-start' add kiya hai */}
          ...
          >
            ...
            <div className="relative h-full w-full overflow-hidden rounded-3xl border border-border-light dark:border-white/10 shadow-2xl group">
              ...
              />
              {/* Floating Badge */}
              <div className="absolute bottom-6 right-6 z-20 bg-white/90 dark:bg-background-dark/90 backdrop-blur-md border border-border-light dark:border-white/10 p-4 rounded-2xl shadow-xl max-w-[200px] hover:scale-105 transition-transform duration-300 cursor-default text-left">
                <div className="flex items-center gap-3 mb-2">
                  <div className="p-1.5 bg-green-500/20 rounded-full text-green-400">
                    <Coffee size={16} />
                  </div>
