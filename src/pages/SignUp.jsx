...
const SignUp = () => {
  ...
  return (
    ...
    >
        ...
        <div className="absolute inset-0 z-20 flex flex-col justify-between p-8 xl:p-12">
          ...
          >
            <blockquote className="text-white text-2xl xl:text-3xl font-bold leading-tight max-w-lg mb-4 xl:mb-6">
              "The journey from bean to cup begins here."
            </blockquote>
      ...
      {/* Right Form Section */}
      <div className="w-full lg:w-1/2 h-full flex flex-col justify-center items-center p-6 sm:p-12 lg:px-12 xl:px-24 lg:py-6 bg-[#12100E] relative overflow-y-auto lg:overflow-hidden">
        ...
        <motion.div
          ...
          initial="initial"
          animate="animate"
          className="w-full max-w-md space-y-4 lg:space-y-6 mt-12 lg:mt-0 pt-8 lg:pt-0 pb-10 lg:pb-0 relative z-10"
        >
          <motion.div
          ...
          >
            ...
            <motion.div variants={fadeSlideUp}>
              <label
                className="block text-sm font-semibold text-[#FDFBF7] mb-1 xl:mb-1.5"
                htmlFor="fullname"
              >
                Full Name
              </label>
              <div className="relative group/input">
                ...
                <input
                  ...
                  type="text"
                  required
                  className="block w-full pl-11 pr-3 py-2.5 bg-[#1c1816] border border-[#3a322c] rounded-xl text-[#FDFBF7] placeholder:text-[#e6dec8]/30 focus:outline-none focus:ring-2 focus:ring-[#b86114]/50 focus:border-[#b86114] focus:shadow-[0_0_15px_rgba(184,97,20,0.15)] transition-all duration-300 shadow-sm hover:border-[#4a423c]"
            ...
            <motion.div variants={fadeSlideUp}>
              ...
              <div className="relative group/input">
                ...
                <input
                  ...
                  required
                  className="block w-full pl-11 pr-11 py-2.5 bg-[#1c1816] border border-[#3a322c] rounded-xl text-[#FDFBF7] placeholder:text-[#e6dec8]/30 focus:outline-none focus:ring-2 focus:ring-[#b86114]/50 focus:border-[#b86114] focus:shadow-[0_0_15px_rgba(184,97,20,0.15)] transition-all duration-300 shadow-sm font-mono hover:border-[#4a423c]"
            ...
            >
              ...
              />
              <label
                className="ml-2 text-sm text-[#e6dec8] cursor-pointer leading-tight xl:leading-normal"
                htmlFor="terms"
              >
                I agree to the{" "}
                <a
                  href="#"
                  className="font-medium text-[#b86114] hover:text-[#e88a2a] transition-all duration-300 hover:underline underline-offset-4 decoration-[#b86114]/50"
                >
                  Terms
                </a>{" "}
                and{" "}
          ...
          <motion.div variants={fadeSlideUp} className="relative mt-4 xl:mt-6">
          ...
          <motion.div
            variants={fadeSlideUp}
            className="grid grid-cols-2 gap-3 xl:gap-4 mt-4"
          >
            <motion.button
              type="button"
              ...
              whileTap={{ scale: 0.97 }}
              transition={{ duration: 0.2 }}
              className="flex items-center justify-center w-full px-4 py-2.5 bg-[#1c1816] border border-[#3a322c] rounded-xl shadow-sm text-sm font-medium text-[#FDFBF7] hover:bg-[#25201d] transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#3a322c]"
            >
              <svg
